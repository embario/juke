...
/// ```swift
/// Button("Submit") { }
///     .buttonStyle(JukeCoreButtonStyle(variant: .primary))
/// ```
...
private struct JukeCoreButtonStyleBody: View {
    let configuration: ButtonStyleConfiguration
    let variant: JukeCoreButtonStyle.Variant
