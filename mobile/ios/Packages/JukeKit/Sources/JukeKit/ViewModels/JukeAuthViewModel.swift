...
///     var body: some View {
///         VStack {
///             JukeKitInputField(label: "Username", placeholder: "Enter username", text: $viewModel.username)
///             // ... other fields
///
///             Button("Submit") {
///                 Task { await viewModel.submit() }
///             }
///             .buttonStyle(JukeKitButtonStyle())
///             .disabled(viewModel.isLoading)
///
///             JukeKitStatusBanner(message: viewModel.errorMessage, variant: .error)
///             JukeKitStatusBanner(message: viewModel.successMessage, variant: .success)
///         }
///     }
/// }
/// ```
