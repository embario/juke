package com.juke.tunetrivia.ui.navigation
...
import com.juke.tunetrivia.core.design.components.TuneTriviaBackground
import com.juke.tunetrivia.core.design.components.TuneTriviaButton
import com.juke.tunetrivia.core.design.components.TuneTriviaButtonVariant
import com.juke.tunetrivia.core.design.components.TuneTriviaCard
import com.juke.tunetrivia.core.design.components.TuneTriviaSpinner
import com.juke.tunetrivia.core.design.components.TuneTriviaStatusBanner
import com.juke.tunetrivia.core.design.components.TuneTriviaStatusVariant
import com.juke.tunetrivia.model.SessionStatus
import com.juke.tunetrivia.model.TuneTriviaSession
import com.juke.tunetrivia.ui.session.home.HomeViewModel
...
private fun NavGraphBuilder.createRoute(navController: NavController) {
    composable("create") {
        com.juke.tunetrivia.ui.session.create.CreateSessionScreen(
...
private fun NavGraphBuilder.joinRoute(navController: NavController, session: SessionSnapshot) {
    composable("join") {
        com.juke.tunetrivia.ui.session.join.JoinSessionScreen(
...
private fun NavGraphBuilder.lobbyRoute(navController: NavController, session: SessionSnapshot) {
    composable("lobby/{sessionId}") { backStackEntry ->
        ...
        com.juke.tunetrivia.ui.session.lobby.SessionLobbyScreen(
            sessionId = sessionId,
...
private fun NavGraphBuilder.addTracksRoute(navController: NavController) {
    composable("add-tracks/{sessionId}/{remaining}") { backStackEntry ->
        ...
        com.juke.tunetrivia.ui.session.tracks.AddTracksScreen(
            sessionId = sessionId,
...
private fun NavGraphBuilder.leaderboardRoute(navController: NavController) {
    composable("leaderboard") {
        com.juke.tunetrivia.ui.leaderboard.LeaderboardScreen(
            onBack = { navController.popBackStack() },
        )
    }
}
...
private fun NavGraphBuilder.gameRoute(navController: NavController, session: SessionSnapshot) {
    composable("game/{sessionId}") { backStackEntry ->
        val sessionId = backStackEntry.arguments?.getString("sessionId")?.toIntOrNull() ?: return@composable
        com.juke.tunetrivia.ui.session.game.GamePlayScreen(
            sessionId = sessionId,
            currentUsername = session.username,
            onBack = { navController.popBackStack() },
        )
