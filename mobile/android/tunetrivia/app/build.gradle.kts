...
android {
    ...
    val backendUrl = System.getenv("BACKEND_URL")
        ?: project.findProperty("tunetrivia.apiBaseUrl") as String?
        ?: error("BACKEND_URL must be set (env var or tunetrivia.apiBaseUrl property).")
    val disableRegistrationRaw = (System.getenv("DISABLE_REGISTRATION")
        ?: project.findProperty("tunetrivia.disableRegistration") as String?
        ?: "false")
        .lowercase()
...
dependencies {
    ...
    testImplementation(testFixtures("fm.juke:core"))
